...
"L’offre complète de SPEEDWIN s’étend du conseil à la pose, en passant par la planification et bien plus encore, nous ressentons l’obligation et en même temps la motivation de fournir des prestations de premier choix tous les jours, car c’est seulement lorsque vous êtes satisfait que nous le sommes aussi."</div>
			...
			<div class="btns-outer text-center">
				...
				<ul class="window-nav clearfix">
					<li><a href="votreprojet.html"> Inspération</a></li>
			...
			<div class="row clearfix" id="it1">
				...
				<div class="content-column col-lg-8 col-md-12 col-sm-12">
					...
					<div class="title-inner"  data-wow-delay="0ms" data-wow-duration="1500ms">
						...
						<div class="text">
							    <p>
              <strong>Fenêtre en aluminium ou PVC,</strong> blanche ou en couleur, que votre maison soit traditionnelle ou contemporaine, vous avez besoin de vous projeter avec votre nouvelle fenêtre, vous avez besoin d’inspiration… !
               </p>
           <p>

            Venez découvrir nos showrooms confortablement aménagés pour vous accueillir. Une large gamme de produits avec différentes formes, typologies, ouvertures et dimensions vous permettrons de mieux imaginer votre nouveau décor.
        </p>
