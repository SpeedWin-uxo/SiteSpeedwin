                    ...
                    <div class="nav-outer clearfix">
						...
						<nav class="main-menu navbar-expand-md">
						 ...
						 <ul class="navigation clearfix">
                                ...
                                <li class=""><a href="index.html">Acceuil</a>

								</li>



								<li class=""><a href="votreprojet.html">Votre Projet</a>

								</li>
								<li class="dropdown"><a href="#">Nos Produits</a>
									<ul>
										<li class="dropdown"><a href="cons.html"><img src="images/9.png" alt="" title="" width="30" height="30">Portes et Fenêtres</a>

										<ul>
										  		<li><a href="cons.html">PVC</a></li>
										<li><a href="cons.html">Aluminium</a></li>
										</ul>

										</li>
										<li><a href="cons.html"><img src="images/7.png" alt="" title="" width="30" height="30">Volets Roulants</a></li>
										<li><a href="cons.html"><img src="images/8.png" alt="" title="" width="30" height="30">Stores d'Interieur</a></li>

									</ul>
								</li>
								<li class=""><a href="services.html">Nos Services</a>

								</li>
								<li class=""><a href="cons.html">Gallerie</a>

								</li>
								<li class=""><a href="recrutement.html">Recrutement</a>
							...
							<div class="row clearfix">
								...
								<div class="column col-lg-6 col-md-6 col-sm-12">
									<ul class="footer-link">
										<li><a href="cons.html">   Fenêtre</a></li>
										<li><a href="cons.html">Portes  </a></li>
										<li><a href="votreprojet.html">Projet</a></li>
										<li><a href="#">Caractéristique</a></li>


										<li><a href="cons.html">Nos Produits</a></li>
									</ul>
								</div>
