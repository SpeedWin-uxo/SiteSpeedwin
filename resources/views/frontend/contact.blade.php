        ...
        <div class="inner-column">
           <ul class="accordion-box">
            ...
            <li class="accordion block">
              <div class="acc-btn"><div class="icon-outer"><span class="icon icon-plus flaticon-plus"></span> <span class="icon icon-minus flaticon-minus"></span></div><strong>ShowRoom Oran</strong></div>
          ...
          <ul class="option-list">
            ...
            <li><span class="icon flaticon-question"></span> adresse@gmail.com</li>
            </br>
            <li><span class="icon flaticon-place"></span>Mohhamadia, alger Algerie</li>
...
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d12790.188444026295!2d3.165931299999992!3d36.73343670000001!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xe19759cb40b8275e!2sUXO%20Group!5e0!3m2!1sfr!2sdz!4v1568210899877!5m2!1sfr!2sdz" width="100%" height="100%" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
            ...
            <li class="accordion block active-block">
              <div class="acc-btn active"><div class="icon-outer"><span class="icon icon-plus flaticon-plus"></span> <span class="icon icon-minus flaticon-minus"></span></div><strong>ShowRoom Blida</strong></div>
...
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d12790.188444026295!2d3.165931299999992!3d36.73343670000001!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xe19759cb40b8275e!2sUXO%20Group!5e0!3m2!1sfr!2sdz!4v1568210899877!5m2!1sfr!2sdz" width="100%" height="100%" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
            ...
            <!--Block-->
            <li class="accordion block">
              <div class="acc-btn"><div class="icon-outer"><span class="icon icon-plus flaticon-plus"></span> <span class="icon icon-minus flaticon-minus"></span></div><strong>ShowRoom Annaba</strong></div>
              <div class="acc-content">
                <div class="content">
                  <ul class="option-list">
            <li><span class="icon flaticon-phone-symbol-of-an-auricular-inside-a-circle"></span><strong>Tel:</strong> +32 89 4567 01</li>
            ...
            <!--Block-->
            <li class="accordion block">
              <div class="acc-btn"><div class="icon-outer"><span class="icon icon-plus flaticon-plus"></span> <span class="icon icon-minus flaticon-minus"></span></div><strong>ShowRoom Khanchlaa</strong></div>
              <div class="acc-content">
                <div class="content">
                  <ul class="option-list">
            <li><span class="icon flaticon-phone-symbol-of-an-auricular-inside-a-circle"></span><strong>Tel:</strong> +32 89 4567 01</li>
          ...
          <div class="contact-form">
            ...
            <form method="post" action="sendemail.php" id="contact-form">
              <div class="row clearfix">
                ...
                <div class="form-group col-lg-12 col-md-12 col-sm-12">
                  <button type="submit" class="theme-btn btn-style-four"><span class="arrow flaticon-right-arrow-4"></span>Envoyer</button>
                                  </div>
              </div>
            </form>
